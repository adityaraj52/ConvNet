...
eval_data = 'test'
checkpoint_dir = global_path_to_cifar10train100k
...
"""
    with tf.Session() as sess:
        ...
        try:
            ...
            num_iter = int(math.ceil(num_examples / cifar10.batch_size))
            true_count = 0  # Counts the number of correct predictions.
            total_sample_count = num_iter * cifar10.batch_size
